...
ADD_FUNCS_TO_MACHINE_7(drive, followLine, moveToTargetSimple, moveToTarget, moveToTargetDis, turnToAngleNewAlg, turnToTargetNewAlg, sweepTurnToTarget);

PREP_FUNC_STATE_6(followLine, float, float, byte, tMttMode, bool, bool);
