...
for cnt in range (minPNum, maxPNum+1):
	...
	f.write("			{ \\ \n")
	f.write("				out = ( gVelocity.x * (float) sin(gPosition.a) )+ (gVelocity.y * (float) cos(gPosition.a)); \\ \n")
	f.write("				if(machine##Logs) writeDebugStreamLine(\"%d:\"#machine\"velSafety out locY= %f\", npgmtime, out); \\ \n")
	f.write("				goodVel = true; \\ \n")
	f.write("				break; \\ \n")
	f.write("			} \\ \n")
