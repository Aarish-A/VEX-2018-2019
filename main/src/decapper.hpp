...
constexpr double DECAPPER_MID_POS = 320;
constexpr double DECAPPER_TOP_BOT_POS = 770;
constexpr double DECAPPER_TOP_MID_POS = 840;
constexpr double DECAPPER_TOP_POS = 1414;
