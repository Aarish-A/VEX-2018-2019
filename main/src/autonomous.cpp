...
void programming_skills_30_points() {
  ...
  // capper.move_to_flag_flip(180);
  // angler.move_to(Angler::CAP_PICKUP_POSITION);
  // drive_turn_sync(FixedAngleTarget(-65.0_deg));
  // drive_move_sync(13.5_in, -65.0_deg);
  // drive_move_async(-11_in, -65.0_deg);
  // drive.wait_for_distance(-7_in);
  // intake.stop();
  angler.move_to(Angler::PICKUP_POSITION);
  // capper.move_to_pickup();
  // drive.wait_for_stop();
  // drive_move_async(12_in, -65.0_deg);
  // drive.wait_for_distance(6.0_in);
  capper.pickup_cap();
  // drive.wait_for_stop();
  // drive_move_sync(-20_in, -65_deg, false);
...
//
//   drive_move_sync(5_in, 0_deg);
//   drive_turn_sync(FixedAngleTarget(-8.5_deg));
...
//   drive_turn_sync(FixedAngleTarget(93.0_deg));
//   angler.move_to(Angler::CAP_PICKUP_POSITION);
//   angler.wait_for_target_reach();
//   intake.intake();
//   drive_move_sync(23_in, 93.0_deg);
//   drive_move_async(-11_in, 93.0_deg);
//   drive.wait_for_distance(-8_in);
//   angler.move_to(Angler::PICKUP_POSITION);
//   intake.stop();
//   capper.move_to_pickup();
//   drive.wait_for_stop();
//   drive_move_async(11_in, 93_deg);
//   drive.wait_for_distance(9_in);
//   capper.pickup_cap(true);
//   drive.wait_for_stop();
//   intake.intake();
...
//   drive.wait_for_stop();
//   intake.intake();
//   drive_turn_sync(FixedAngleTarget(-82_deg));
//   drive_move_sync(-33_in, -82_deg, false);
//   cap_on_pole();
//   drive_move_sync(38_in,0_deg);
