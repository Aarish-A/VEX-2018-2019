...
constexpr int MAX_AMNT_TO_FLUSH = 1000; // Maximum amount of characters allowed to be flushed to the SD at once. Flushing 1000 takes approx. 13ms
...
void flush_to_sd(int given_amnt_to_flush); // Flushes given_amnt_to_flush of indices (capped at MAX_AMNT_TO_FLUSH), to the sd card
