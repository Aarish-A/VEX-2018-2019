...
/* Puncher */
constexpr uint8_t BTN_SHOT_CANCEL_MASTER = GET_BTN_INDEX(pros::E_CONTROLLER_DIGITAL_Y);
constexpr uint8_t BTN_SHOT_CANCEL_PARTNER = GET_BTN_INDEX(pros::E_CONTROLLER_DIGITAL_B);
constexpr uint8_t BTN_PUNCHER_RESET_UP = GET_BTN_INDEX(pros::E_CONTROLLER_DIGITAL_UP);
constexpr uint8_t BTN_PUNCHER_RESET_RIGHT = GET_BTN_INDEX(pros::E_CONTROLLER_DIGITAL_RIGHT);
...
/* Decapper */
constexpr uint8_t BTN_DECAPPER_UP = GET_BTN_INDEX(pros::E_CONTROLLER_DIGITAL_UP);
constexpr uint8_t BTN_DECAPPER_DOWN = GET_BTN_INDEX(pros::E_CONTROLLER_DIGITAL_LEFT);
