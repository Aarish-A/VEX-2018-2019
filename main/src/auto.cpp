...
void move_drive(double dis, int vel, bool stop) {
  ...
  log("%d Moved to FL: %f, BL: %f, FR: %f, BR %f\n", millis(), drive_fl.get_position(), drive_bl.get_position(), drive_fr.get_position(), drive_br.get_position());
