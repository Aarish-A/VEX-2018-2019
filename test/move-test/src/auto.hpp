...
constexpr long double IN_TO_TK(long double val) { return (val * DRIVE_TPR) / (DRIVE_DIA * M_PI); }
constexpr long double CM_TO_IN(long double val) { return val  * 2.54; }
constexpr long double DEG_TO_RAD(long double val) { return val * M_PI / 180.0; }
